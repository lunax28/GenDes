    ...
    public void doGenerateDescription() {
        ...
        if (result > 0) {
            ...
            switch (this.choiceBoxLanguage.getValue()) {
                ...
                case ("EN"):
                    this.generateEnDescription(albumUrl);
                    break;

                case ("ES"):
                    this.generateEsDescription(albumUrl);
                    break;

                case ("DE"):
                    this.generateDeDescription(albumUrl);
                    break;

                case ("PT"):
                    this.generatePtDescription(albumUrl);
                    break;

                case ("IT"):
                    this.generateItDescription(albumUrl);
                    break;
